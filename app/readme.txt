- [signal_processinglib] create_video -> fix video mn, mx cutoff 
...
- predict_text -> need to fix visibility of button, predicts the text after the clusters are created, abstract out transition probability, hmm should have garbage output, tuned probability that can be adjusted to throw away keystrokes in the hmm
- start_confuser -> connect bens stuff, add listener to current environment, inject only when typing, inject user specific audio
